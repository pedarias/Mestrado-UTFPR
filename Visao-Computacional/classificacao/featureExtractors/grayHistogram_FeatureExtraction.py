...
# Descritor de Cor
# Extrair um histograma para cada imagem
def extractGrayHistogramFeatures(images):
    ...
    featuresList = [] # lista p guardar histograma de cada imagem
    for image in images:
...
# converte as classes de string para numeros
def encodeLabels(labels):
    ...
    return np.array(encoded_labels,dtype=object), encoder.classes_ # guarda o enconder p depois voltar

# cria um arquivo csv e dentro dele coloca todas as caracteristicas que foram extraidas
